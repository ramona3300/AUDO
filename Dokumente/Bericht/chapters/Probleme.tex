...
Die Halterung besteht aus einem unteren Teil zur Befestigung am Fahrzeug, einem Mittelteil der das Emblem der Gruppe zeigt, sowie einem oberen Teil, auf dem die Webcam montiert wird. \autoref{fig:halterung} zeigt den kompletten Aufbau.

\todo{Bild fehlt noch}
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.35\textwidth]{images/Desert.jpg}
